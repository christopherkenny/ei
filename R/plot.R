...
#' page 204.} \item{tomogCI}{Tomography plot with \eqn{80\%} confidence
...
#' 179.} \item{tomogCI95}{Tomography plot with \eqn{95\%} confidence intervals.
...
#' and \eqn{\beta_i^w} points.} \item{tomogP}{Tomography plot with mean
...
#' point estimates of \eqn{\beta_i^w}'s with whiskers.} \item{xt}{Basic
...
#' tomography lines.} \item{boundXb}{\eqn{X_i} by the bounds on \eqn{\beta_i^b}
#' (each precinct appears as one vertical line), see the lines in the left
#' graph in Figure 13.2, page 238.} \item{boundXw}{\eqn{X_i} by the bounds on
#' \eqn{\beta_i^w} (each precinct appears as one vertical line), see the lines
#' in the right graph in Figure 13.2, page 238.} \item{truth}{Compares truth to
...
#' return), or stop (hit "s" and return).} \item{movie}{For each observation,
